...
variable "db_name" {
  ...
  type        = string
  default     = "wordpress-db"  # You can change the default database name as needed
}
...
variable "igw_name" {
  ...
  type        = string
  default     = "main_igw"  # You can change the default name as needed
}
...
variable "subnet_name" {
  ...
  type        = string
  default     = "main_subnet"  # You can change the default name as needed
}
...
variable "db_allocated_storage" {
  ...
  type        = number
  default     = 20  # You can change the default allocated storage as needed
}
...
variable "cache_parameter_group" {
  ...
  type        = string
  default     = "default.redis5.0"  # You can change the default parameter group name as needed
}
...
variable "cache_port" {
  ...
  type        = number
  default     = 6379  # Default port for Redis
}
...
variable "route_table_name" {
  ...
  type        = string
  default     = "main_route_table"  # You can change the default name as needed
}
...
variable "s3_bucket_acl" {
  ...
  type        = string
  default     = "private"  # You can change the default ACL as needed
}